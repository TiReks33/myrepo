...
namespace UCTEST
{
    public partial class FormMain : Form
    {
        ...
        private void buttonClose_Click(object sender, EventArgs e)
        {
            ...
            else { MessageBox.Show("Тебе делать нечего? Работай давай!", "Мда"); }
        }
        ...
        private void toolStripStatusLabelOPCConnection_Click(object sender, EventArgs e)
        {
        ...
        private void OPC1_Load(object sender, EventArgs e)
        {
